...
<body>
    ...
    <section class="newnavbar">
        ...
        <nav class="navbar navbar-expand-lg ">
            <div class="container-fluid">
                <a class="navbar-brand" href="#"><img src="./assets/images/thrift fashion logo-01.png"
    ...
    <center>
        ...
        <h1
            style="background:linear-gradient(rgba(247, 203, 10, 0.822),rgba(0, 0, 0, 0.404)),url(../images/product-1.jpg);color:white; padding: 30px;background-position: center;background-size:cover ;">
            Products</h1>
