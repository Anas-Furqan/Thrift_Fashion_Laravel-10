                    ...
                    <div class="row no-gutters">
                        <div class="col-lg-8 col-md-7 order-md-last d-flex align-items-stretch">
                            <div class="contact-wrap w-100 p-md-5 p-4 rounded-right">
                                ...
                                <form method="POST" action="/signUpForm" id="signUpForm" name="signUpForm"
                                    class="contactForm">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-12">
                                        ...
                                        <div class="col-md-6 mt-3">
                                            <div class="form-group">
                                                ...
                                                <input type="password" class="form-control" name="cnfrmpass" id="cnfrmpass"
                                        ...
                                        <div class="col-md-6 mt-3">
                                            <div class="form-group">
                                                <a href="/SignIn" class="ms-5 btn btn-info">Already have an account?</a>
                                            </div>
                                        </div>
                                    </div>
                                </form>
